...
public class App {
    public static void main(String[] args) {
        ...
        String mr231_RSD_Invalid = "$RARSD,14.0,0.0,96.9,306.4,,,,,97.7,11.6,0.3,K,N,S*20";
        ...
        searadarMessages.forEach(System.out::println);
        searadarMessages = converter.convert(mr231_RSD_Invalid);
        searadarMessages.forEach(System.out::println);
        ...
        String mr231_3_RSD_Invalid = "$RARSD,14.0,0.0,96.9,306.4,,,,,97.7,11.6,0.3,K,N,S*20";
        ...
        searadarMessages_3.forEach(System.out::println);
        searadarMessages_3 = converter.convert(mr231_3_RSD_Invalid);
        searadarMessages_3.forEach(System.out::println);
    }
}
